...
from ldm.models.diffusion.ddpm_mask import LatentDiffusion
...
class ControlLDM(LatentDiffusion):
    ...
    def get_input(self, batch, k, bs=None, *args, **kwargs):
        ...
        x, c = super().get_input(batch, self.first_stage_key,mask, *args, **kwargs)
        ...
        mask_latent = mask
        return x, dict(c_crossattn=[c], c_latent=[c_latent], lq=[lq], c_concat=[control],mask=[mask],mask_latent=[mask_latent]), mask
